...
switch (numbuttons) {
	...
	case 2:
		...
		break;
	default:
		console.log(`This wasn't supposed to happen! Try re-running the program, or file an issue in the GitHub repo if this persists.`);
		process.exit();
		break;
}
...
try { fs.writeFileSync('presence.js', content); }
